...
const HighRiskWidget: React.FC<Props> = ({className, backGroundColor, chartHeight}) => {
    ...
    >
      ...
      <div className='card-body d-flex flex-column'>
        ...
        <div className='pt-5'>
          ...
          {/* begin::Number */}
          <span className='text-dark fw-bolder fs-3x me-2 lh-0'>244</span>
          {/* end::Number */}
